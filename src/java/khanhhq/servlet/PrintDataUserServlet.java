 ...
 */
public class PrintDataUserServlet extends HttpServlet {
    private final Logger log = Logger.getLogger(PrintDataUserServlet.class.getName());
    private final String DATAUSER = "displayUser.jsp";
