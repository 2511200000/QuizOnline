...
public class HistoryUserServlet extends HttpServlet {
    ...
    private final Logger log = Logger.getLogger(HistoryUserServlet.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            daoMark.printListMarkUser(userID);
            List<TblMartUserDTO> result = daoMark.getlistMarkUser();
             if (result != null) {
                url = SUCCESS;
